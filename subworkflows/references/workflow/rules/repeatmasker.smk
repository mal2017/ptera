...
rule bedops_parse_repeatmasker:
    """
    Now that I outsource masking etc to its own repo, this just removes simple repeats
    """
    input:
        rpmskr = rules.get_resources_in_mount.output.REPEATMASKED_LOCI,
    output:
        "results/repeatmasker/reference_insertions.bed"
    resources:
        mem=2000,
